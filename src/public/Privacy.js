...
export default function Privacy() {
  return (
    <>
        ...
        <br />
        <p>
        TAYARI PAYMENTS COMPANY owner of “TAYARI” (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the “Application”). Please read this Privacy Policy carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS THE APPLICATION.
        </p>
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>COLLECTION OF YOUR INFORMATION</h5>
        <br />
        <p>
        We may collect information about you in a variety of ways. The information we may collect via the Application depends on the content and materials you use and includes:
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Personal Data</h6>
            <p>
            ...
            <br />
        <h6 style={{ fontWeight: "600" }}>Derivative Data</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Financial Data</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Facebook Permissions</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Data from Social Networks</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Geo-Location Information</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Mobile Device Access</h6>
        <p>
        We will inform you when the application demands any access from your mobile phone, at the moment we don’t have features that demand device access.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Mobile Device Data</h6>
        <p>
        Device information such as your mobile device ID number, model, and manufacturer, version of your operating system, phone number, country, location, and any other data you choose to provide.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Push Notifications</h6>
        <p>
        We may request to send you push notifications regarding your account or the Application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Third-Party Data</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Data From Contests, Giveaways, and Surveys</h6>
        <p>
        Personal and other information you may provide when entering contests or giveaways and/or responding to surveys.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>USE OF YOUR INFORMATION</h5>
        <br />
        <p>
        ...
        <ol>
            ...
            <li>
            Fulfil and manage purchases, orders, payments, and other transactions related to the Application.
            </li>
            <li>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>DISCLOSURE OF YOUR INFORMATION</h5>
        <br />
        <p>
        We may share information we have collected about you in certain situations. Your information may be disclosed as follows:
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>By Law or to Protect Rights</h6>
        <p>
        If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation. This includes exchanging information with other entities for fraud protection and credit risk reduction.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Third-Party Service Providers</h6>
        <p>
        We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Marketing Communications</h6>
        <p>
        With your consent, or with an opportunity for you to withdraw consent, we may share your information with third parties for marketing purposes, as permitted by law.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Interactions with Other Users</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Online Postings</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Third-Party Advertisers</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Affiliates</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Business Partners</h6>
        <p>
        We may share your information with our business partners to offer you certain products, services or promotions.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Offer Wall</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Social Media Contacts</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Other Third Parties</h6>
        <p>
        We may share your information with advertisers and investors for the purpose of conducting general business analysis. We may also share your information with such third parties for marketing purposes, as permitted by law.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Sale or Bankruptcy</h6>
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>TRACKING TECHNOLOGIES</h5>
        <br />
        <h6 style={{ fontWeight: "600" }}>Cookies and Web Beacons</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Internet-Based Advertising</h6>
        <p>
        Additionally, we may use third-party software to serve ads on the Application, implement email marketing campaigns, and manage other interactive marketing initiatives. This third-party software may use cookies or similar tracking technology to help manage and optimize your online experience with us. For more information about opting-out of interest-based ads, visit the Network Advertising Initiative Opt-Out Tool or Digital Advertising Alliance Opt-Out Tool.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Website Analytics</h6>
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>THIRD-PARTY WEBSITES</h5>
        <br />
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>SECURITY OF YOUR INFORMATION</h5>
        <br />
        <p>
        We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse. Any information disclosed online is vulnerable to interception and misuse by unauthorized parties. Therefore, we cannot guarantee complete security if you provide personal information.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>POLICY FOR CHILDREN</h5>
        <br />
        <p>
        We do not knowingly solicit information from or market to children under the age of 13. If you become aware of any data we have collected from children under age 13, please contact us using the contact information provided below.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>CONTROLS FOR DO-NOT-TRACK FEATURES</h5>
        <br />
        <p>
        Most web browsers and some mobile operating systems and our mobile application include a Do-Not-Track (“DNT”) feature or setting you can activate to signal your privacy preference not to have data about your online browsing activities monitored and collected. No uniform technology standard for recognizing and implementing DNT signals has been finalized. As such, we do not currently respond to DNT browser signals or any other mechanism that automatically communicates your choice not to be tracked online. If a standard for online tracking is adopted that we must follow in the future, we will inform you about that practise in a revised version of this Privacy Policy.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>OPTIONS REGARDING YOUR INFORMATION</h5>
        <br />
        <h6 style={{ fontWeight: "600" }}>Account Information</h6>
        <p>
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Emails and Communications</h6>
        <p>
