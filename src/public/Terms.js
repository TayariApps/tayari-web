...
export default function Terms() {
  return (
    <>
      <NavigationBar />
      <div className="my-5 container" style={{ textAlign: "justify" }}>
        <h4 style={{ textAlign: "center" }}>Terms & Conditions</h4>
        <br />
        <h5 style={{ fontWeight: "700" }}>AGREEMENT TO TERMS</h5>
        <br />
        <p>
          These Terms and Conditions constitute a legally binding agreement made
          between you, whether personally or on behalf of an entity (“you”) and
          TAYARI PAYMENTS COMPANY (“we,” “us” or “our”), concerning your access
          to and use of our mobile application (the “Application”). You agree
          that by accessing the Application, you have read, understood, and
          agree to be bound by all of these Terms and Conditions Use. IF YOU DO
          ...
          right, in our sole discretion, to make changes or modi cations to
          ...
          these Terms and Conditions and you waive any right to receive speci c
          ...
          Terms are posted. The information provided on the Application is not
          ...
          laws are applicable. The Application is intended for users who are at
          ...
          to use the Application. If you are a minor, you must have your parent
          or guardian read and agree to these Terms of Use prior to you using
          the Application.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>INTELLECTUAL PROPERTY RIGHTS</h5>
        <br />
        <p>
          ...
          unfair competition laws of the United Republic of Tanzania, foreign
          ...
          all rights not expressly granted to you in and to the Application,
          Content, and the Marks.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>USER REPRESENTATIONS</h5>
        <br />
        <p>
          ...
          parental permission to use the Site; (6) you will not access the
          Application through automated or non-human means, whether through a
          bot, script or otherwise; (7) you will not use the Application for any
          illegal or unauthorized purpose; and (8) your use of the Application
          will not violate any applicable law or regulation. If you provide any
          ...
          all current or future use of the Application(or any portion thereof).
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>USER REGISTRATION</h5>
        <br />
        <p>
          You may be required to register with the Application. You agree to
          keep your password con dential and will be responsible for all use of
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>PROHIBITED ACTIVITIES</h5>
        <br />
        <p>
          You may not access or use the Application for any purpose other than
          that for which we make the Application available. The Application may
          not be used in connection with any commercial endeavours except those
          that are speci cally endorsed or approved by us. As a user of the
        ...
        <ol>
          ...
          <li>
            Make any unauthorized use of the Application, including collecting
          ...
          <li>
            Use the Application to advertise or to sell goods and services
            unless when approved by us with written consent and signature.
          </li>
          <li>
          ...
          <li>
            Use the Application as part of any e ort to compete with us or
          ...
          <li>
            Copy or adapt the application’s software, including but not limited
          ...
          <li>
            ...
            Application or modi es, impairs, disrupts, alters, or interferes
          ...
          <li>
            ...
            utility, scraper, or offline reader that accesses the Application,
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>USER GENERATED CONTRIBUTIONS</h5>
        <br />
        <p>
          ...
          materials to us or on the Application, including but not limited to
          ...
          Application and through third-party websites. As such, any
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>CONTRIBUTION LICENSE</h5>
        <br />
        <p>
        ...
        <p>
          ...
          in your Contributions provided by you in any area on the Application.
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>GUIDELINES FOR REVIEWS</h5>
        <br />
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>MOBILE APPLICATION LICENSE</h5>
        <br />
        <h6 style={{ fontWeight: "600" }}>Use License</h6>
        <p>
          If you access the Application via a mobile application, then we grant
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Apple and Android Devices</h6>
        <br />
        <p>
          ...
          to access the Application: (1) the license granted to you for our
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>SOCIAL MEDIA</h5>
        <br />
        <p>
          As part of the functionality of the Application, you may link your
          ...
          Application; or (2) allowing us to access your Third-Party Account, as
          ...
          available on and through the Application via your account, including
          ...
          account on the Application. Please note that if a Third-Party Account
          ...
          the Application. You will have the ability to disable the connection
          between your account on the Application and your Third-Party Accounts
          at any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>SUBMISSIONS</h5>
        <br />
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>THIRD-PARTY WEBSITES AND CONTENT</h5>
        <br />
        <p>
          The Application may contain (or you may be sent via the Application)
          ...
          Websites accessed through the Application or any Third-Party Content
          posted on, available through, or installed from the Application,
          ...
          thereof by us. If you decide to leave the Application and access the
          ...
          which you navigate from the Application or relating to any
          applications you use or install from the Application. Any purchases
          you make through Third-Party Websites will be through other websites
          and from other companies, and we take no responsibility whatsoever in
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>ADVERTISERS</h5>
        <br />
        <p>
          ...
          Application and any services provided on the Application or products
          ...
          place advertisements on the Application, including, but not limited
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>APP MANAGEMENT</h5>
        <br />
        <p>
          We reserve the right, but not the obligation, to: (1) monitor the
          Application for violations of these Terms of Use; (2) take appropriate
          ...
          from the Application or otherwise disable all files and content that
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>PRIVACY POLICY</h5>
        <br />
        <p>
          We care about data privacy and security. Please review our Privacy
          Policy . By using the Application, you agree to be bound by our
          Privacy Policy, which is incorporated into these Terms of Use. Please
          be advised the Application is hosted in the United States. If you
          access the Application from the European Union, Asia, or any other
          ...
          Application or Services, you are transferring your data to the United
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Notifications</h6>
        <p>
          ...
          linked to by the Application infringes your copyright, you should
        ...
        <p>
          ...
          or, if multiple copyrighted works on the Application are covered by
          the Notification, a representative list of such works on the
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Counter Notification</h6>
        <p>
        ...
        <p>
          Designated Copyright Agent: At the moment us our company address below
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>COPYRIGHT INFRINGEMENTS</h5>
        <br />
        <p>
          We respect the intellectual property rights of others. If you believe
          that any material available on or through the Application infringes
          ...
          not sure that material located on or linked to by the Application
          infringes your copyright, you should consider first contacting an
          attorney.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>TERM AND TERMINATION</h5>
        <br />
        <p>
          These Terms of Use shall remain in full force and effect while you use
          the Application. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>MODIFICATIONS AND INTERRUPTIONS</h5>
        <br />
        <p>
          We reserve the right to change, modify, or remove the contents of the
          Application at any time or for any reason at our sole discretion
          without notice. However, we have no obligation to update any
          information on our Application. We also reserve the right to modify or
          discontinue all or part of the Application without notice at any time.
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>GOVERNING LAW</h5>
        <br />
        <p>
          These Terms of Use and your use of the Application are governed by and
          construed in accordance with the laws of the United Republic of
          Tanzania , without regard to its conflict of law principles.
        </p>
        <br />
        <h5 style={{ fontWeight: "700" }}>DISPUTE RESOLUTION</h5>
        <br />
        <h6 style={{ fontWeight: "600" }}>Informal Negotiations</h6>
        <p>
          ...
          expressly provided below) informally for at least one year before
          initiating arbitration. Such informal negotiations commence upon
          written notice from one Party to the other Party.
        </p>
        <br />
        <h6 style={{ fontWeight: "600" }}>Binding Arbitration</h6>
        <p>
          ...
          Rules of the Tanzania Arbitration Agreements (“TAA”) and, where
          appropriate, the TAA’s Supplementary Procedures for Consumer Related
          Disputes (“TAA Consumer Rules”). Your arbitration fees and your share
          of arbitrator compensation shall be governed by the TAA Consumer Rules
          and, where appropriate, limited by the TAA Consumer Rules. [If such
          ...
          applicable TAA rules or applicable law, the arbitration will take
          place in Tanzania. Except as otherwise provided herein, the Parties
        ...
        <p>
          ...
          and federal courts located in Tanzania and the Parties hereby consent
          to and waive all defences of lack of personal jurisdiction, and forum
          non-convenient with respect to venue and jurisdiction in such state
        ...
        <p>
          ...
          way to the Application be commenced more than 3 years after the cause
        ...
        <br />
        <h6 style={{ fontWeight: "600" }}>Option 3: Binding Arbitration</h6>
        <p>
          To expedite resolution and control the cost of any dispute,
          controversy or claim related to these Terms of Use (each a “Dispute”
          ...
          and conducted under the Commercial Arbitration Rules of the Tanzania
          Arbitration Agreements (“TAA”) and, where appropriate, the TAA’s
          Supplementary Procedures for Consumer-Related Disputes (“TAA Consumer
          Rules”). Your arbitration fees and your share of arbitrator
          compensation shall be governed by the TAA Consumer Rules and, where
          appropriate, limited by the TAA Consumer Rules. [If such costs are
        ...
        <p>
          In no event shall any Dispute brought by either Party related in any
          way to the Application or Services be commenced more than 4 years
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>CORRECTIONS</h5>
        <p>
          ...
          the Application, including descriptions, pricing, availability, and
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>DISCLAIMER</h5>
        <p>
          THE APPLICATION IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU
          AGREE THAT YOUR USE OF THE APPLICATION SERVICES WILL BE AT YOUR SOLE
          RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL
          WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE APPLICATION AND
          YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED
          WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
          NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
          ACCURACY OR COMPLETENESS OF THE APPLICATION’S CONTENT OR THE CONTENT
          OF ANY WEBSITES LINKED TO THIS APPLICATION AND WE WILL ASSUME NO
          LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR
          INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY
          DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND
          USE OF THE APPLICATION, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR
          SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR
          FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR
          CESSATION OF TRANSMISSION TO OR FROM THE APPLICATION, (5) ANY BUGS,
          VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR
          THROUGH THE APPLICATION BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR
          OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF
          ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED,
          TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE APPLICATION. WE DO
          ...
          APPLICATION, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>LIMITATIONS OF LIABILITY</h5>
        <p>
          IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE
          TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL,
          EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST
          PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR
          USE OF THE APPLICATION, EVEN IF WE HAVE BEEN ADVISED OF THE
          ...
          [THE LESSER OF] [THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE [#
          of months] MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING [OR]
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>INDEMNIFICATION</h5>
        <p>
          ...
          right, at your expense, to assume the exclusive defence and control of
          any matter for which you are required to indemnify us, and you agree
          to cooperate, at your expense, with our defence of such claims. We
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>USER DATA</h5>
        <p>
        ...
        <br />
        <h5 style={{ fontWeight: "700" }}>MISCELLANEOUS</h5>
        <p>
          These Terms of Use and any policies or operating rules posted by us on
          the Application constitute the entire agreement and understanding
